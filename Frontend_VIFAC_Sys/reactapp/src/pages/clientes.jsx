  ...
  return (
    <div className="container mt-4">
      ...
      <div className="container mb-1 d-flex justify-content-start gap-1">
        <button className="btn btn-outline-secondary" onClick={() => (window.location.href = "/indexServlet")}>Inicio</button>
        <button className="btn btn-outline-success" onClick={() => (window.location.href = "/VenderServlet")}>Continuar Venta</button>

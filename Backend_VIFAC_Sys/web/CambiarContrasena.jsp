...
<body class="bg-white">
    <div class="header-container">
        <div class="left-text">Actualizar Contraseña</div>
                                    ...
                                    <form action="CambiarContrasenaServlet" method="post">
                                        ...
                                        <!-- Contraseña antigua -->
                                         <div class="form-floating mb-3">
                                           <input class="form-control" name="inputOldPassword"  type="password" placeholder="Contraseña Antigua" required />
                                        ...
                                        <div class="d-flex justify-content-between mt-4 mb-0 gap-3">
                                            <a class="small" href="indexServlet">Cancelar / Regresar</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="confirmChangePasswordModalLabel">Confirmar la actulización de Contraseña</h5>

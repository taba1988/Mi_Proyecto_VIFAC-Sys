...
<body class="d-flex flex-column min-vh-100 mt-2">
            ...
            <aside class="col-lg-2 mb-3 d-none d-lg-block" aria-label="Barra lateral de categorías">
                <nav class="border rounded p-3 h-100">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-5 mt-5">
                        <a href="indexServlet" class="menu-link d-flex flex-column align-items-center text-decoration-none text-dark icon-hover-text">
            ...
            <aside class="col-lg-4 mb-3" aria-label="Carrito de compras">
                <div class="card h-100">
                    ...
                    <div class="d-flex justify-content-around mb-2" id="metodosPago">
                        <button class="btn btn-light btn-sm border-0 metodo-pago-btn metodo-pago-btn-size" data-metodo="Efectivo" title="Efectivo">
                            <i class="bi bi-wallet2 fs-5"></i>
                        </button>
                        <button class="btn btn-light btn-sm border-0 metodo-pago-btn metodo-p-btn-size" data-metodo="Crédito" title="Crédito">
                            <i class="bi bi-credit-card fs-5"></i>
                        </button>
                        <button class="btn btn-light btn-sm border-0 metodo-pago-btn metodo-pago-btn-size" data-metodo="QR" title="QR">
                            <i class="bi bi-qr-code-scan fs-5"></i>
                        </button>
                        <button class="btn btn-light btn-sm border-0 metodo-pago-btn metodo-pago-btn-size" data-metodo="Tarjeta" title="Tarjeta">
                            <i class="bi bi-credit-card-2-front fs-5"></i>
                        </button>
                        <button class="btn btn-light btn-sm border-0 metodo-pago-btn-size" data-bs-toggle="modal" data-bs-target="#modalDescuento" title="Descuento" id="btnDescuento">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCategorias" aria-labelledby="offcanvasCategoriasLabel" class="offcanvas-custom">
        ...
        <div class="offcanvas-body d-flex flex-column justify-content-between p-0">
            ...
            <div class="d-flex justify-content-center align-items-center gap-5 position-relative offcanvas-menu">
                <a href="indexServlet" class="d-flex flex-column align-items-center text-decoration-none text-dark">
    ...
    <script> window.idUsuarioSesion = <%= session.getAttribute("idUsuario") %>;</script>
